...
from users.views import (UserRegisterView, CheckActivationCodeGenericAPIView, ResetPasswordView,
                         ResetPasswordConfirmView, UserUpdateView, SendVerificationCodeAPIView, EmailTokenObtainPairView)
