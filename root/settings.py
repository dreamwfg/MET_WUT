...
# Email Config (Update existing section)
...
# Cache Config (Update existing CACHES)
CACHES = {
    'default': {
...
JAZZMIN_SETTINGS = {
    ...
    # path should be relative within static files (no leading slash)
    "site_logo": "webster-university.jpg",
